...
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? iconName = null,Object? memberIds = null,Object? bannedMemberIds = null,Object? inviteCode = null,}) {
  return _then(LeaderboardCreate(
...
class _LeaderboardCreate implements LeaderboardCreate {
  const _LeaderboardCreate({required this.name, required this.iconName, required  Set<String> memberIds,  Set<String> bannedMemberIds = const {}, required this.inviteCode}): _memberIds = memberIds,_bannedMemberIds = bannedMemberIds;
