...
final _badgeDefinitions = <BadgeDefinition>[
  ...
  (
    id: OnetimeBadgeId.mastiToJakDrak.id,
    name: 'Mastí to jak drak',
    description:
        'Je vidět, že jsi gurmán. Alpský ryzlink nepije jen tak někdo!',
    iconPath: 'assets/badges/masti_to_jak_drak.png',
    iconFillsCircle: true,
    category: BadgeCategory.onetimeEvent,
    goal: null,
  ),
];
