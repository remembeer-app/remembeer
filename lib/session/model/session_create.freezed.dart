...
mixin _$SessionCreate {
 ...
 String get name; DateTime get startedAt; DateTime? get endedAt; Set<String> get memberIds; Set<String> get bannedMemberIds; bool get isSoloSession; List<Drink> get drinks; String get description;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,startedAt,endedAt,const DeepCollectionEquality().hash(memberIds),const DeepCollectionEquality().hash(bannedMemberIds),isSoloSession,const DeepCollectionEquality().hash(drinks),description);

@override
String toString() {
  return 'SessionCreate(name: $name, startedAt: $startedAt, endedAt: $endedAt, memberIds: $memberIds, bannedMemberIds: $bannedMemberIds, isSoloSession: $isSoloSession, drinks: $drinks, description: $description)';
}
...
@useResult
$Res call({
 String name, DateTime startedAt, DateTime? endedAt, Set<String> memberIds, Set<String> bannedMemberIds, bool isSoloSession, List<Drink> drinks, String description
});
...
/// Create a copy of SessionCreate
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? startedAt = null,Object? endedAt = freezed,Object? memberIds = null,Object? bannedMemberIds = null,Object? isSoloSession = null,Object? drinks = null,Object? description = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  DateTime startedAt,  DateTime? endedAt,  Set<String> memberIds,  Set<String> bannedMemberIds,  bool isSoloSession,  List<Drink> drinks,  String description)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SessionCreate() when $default != null:
return $default(_that.name,_that.startedAt,_that.endedAt,_that.memberIds,_that.bannedMemberIds,_that.isSoloSession,_that.drinks,_that.description);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  DateTime startedAt,  DateTime? endedAt,  Set<String> memberIds,  Set<String> bannedMemberIds,  bool isSoloSession,  List<Drink> drinks,  String description)  $default,) {final _that = this;
switch (_that) {
case _SessionCreate():
return $default(_that.name,_that.startedAt,_that.endedAt,_that.memberIds,_that.bannedMemberIds,_that.isSoloSession,_that.drinks,_that.description);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  DateTime startedAt,  DateTime? endedAt,  Set<String> memberIds,  Set<String> bannedMemberIds,  bool isSoloSession,  List<Drink> drinks,  String description)?  $default,) {final _that = this;
switch (_that) {
case _SessionCreate() when $default != null:
return $default(_that.name,_that.startedAt,_that.endedAt,_that.memberIds,_that.bannedMemberIds,_that.isSoloSession,_that.drinks,_that.description);case _:
  return null;
...
class _SessionCreate implements SessionCreate {
  const _SessionCreate({required this.name, required this.startedAt, this.endedAt, required final  Set<String> memberIds, final  Set<String> bannedMemberIds = const {}, this.isSoloSession = true, final  List<Drink> drinks = const [], this.description = ''}): _memberIds = memberIds,_bannedMemberIds = bannedMemberIds,_drinks = drinks;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SessionCreate&&(identical(other.name, name) || other.name == name)&&(identical(other.startedAt, startedAt) || other.startedAt == startedAt)&&(identical(other.endedAt, endedAt) || other.endedAt == endedAt)&&const DeepCollectionEquality().equals(other._memberIds, _memberIds)&&const DeepCollectionEquality().equals(other._bannedMemberIds, _bannedMemberIds)&&(identical(other.isSoloSession, isSoloSession) || other.isSoloSession == isSoloSession)&&const DeepCollectionEquality().equals(other._drinks, _drinks)&&(identical(other.description, description) || other.description == description));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,startedAt,endedAt,const DeepCollectionEquality().hash(_memberIds),const DeepCollectionEquality().hash(_bannedMemberIds),isSoloSession,const DeepCollectionEquality().hash(_drinks),description);
...
/// Create a copy of SessionCreate
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? startedAt = null,Object? endedAt = freezed,Object? memberIds = null,Object? bannedMemberIds = null,Object? isSoloSession = null,Object? drinks = null,Object? description = null,}) {
