...
mixin _$PartyQuest {
 ...
 String get id; String get templateId; String get titleSnapshot; String get instructionsSnapshot; String get eligibilityRuleSnapshot; List<String> get targetClassMemberIds; int get pointsUnits;@TimestampConverter() DateTime get startsAt;@TimestampConverter() DateTime get endsAt; PartyQuestStatus get status; List<String> get eligibleMemberIds; List<String> get eligiblePairKeys; List<String> get completedPairKeys;@TimestampConverterOptimistic() DateTime get createdAt;
...
int get hashCode {
  final _this = this as PartyQuest;
  return Object.hash(runtimeType,_this.id,_this.templateId,_this.titleSnapshot,_this.instructionsSnapshot,_this.eligibilityRuleSnapshot,const DeepCollectionEquality().hash(_this.targetClassMemberIds),_this.pointsUnits,_this.startsAt,_this.endsAt,_this.status,const DeepCollectionEquality().hash(_this.eligibleMemberIds),const DeepCollectionEquality().hash(_this.eligiblePairKeys),const DeepCollectionEquality().hash(_this.completedPairKeys),_this.createdAt);
}

@override
String toString() {
  final _this = this as PartyQuest;
  return 'PartyQuest(id: ${_this.id}, templateId: ${_this.templateId}, titleSnapshot: ${_this.titleSnapshot}, instructionsSnapshot: ${_this.instructionsSnapshot}, eligibilityRuleSnapshot: ${_this.eligibilityRuleSnapshot}, targetClassMemberIds: ${_this.targetClassMemberIds}, pointsUnits: ${_this.pointsUnits}, startsAt: ${_this.startsAt}, endsAt: ${_this.endsAt}, status: ${_this.status}, eligibleMemberIds: ${_this.eligibleMemberIds}, eligiblePairKeys: ${_this.eligiblePairKeys}, completedPairKeys: ${_this.completedPairKeys}, createdAt: ${_this.createdAt})';
}
...
@useResult
$Res call({
 String id, String templateId, String titleSnapshot, String instructionsSnapshot, String eligibilityRuleSnapshot, List<String> targetClassMemberIds, int pointsUnits,@TimestampConverter() DateTime startsAt,@TimestampConverter() DateTime endsAt, PartyQuestStatus status, List<String> eligibleMemberIds, List<String> eligiblePairKeys, List<String> completedPairKeys,@TimestampConverterOptimistic() DateTime createdAt
});
...
as String,eligibilityRuleSnapshot: null == eligibilityRuleSnapshot ? _self.eligibilityRuleSnapshot : eligibilityRuleSnapshot // ignore: cast_nullable_to_non_nullable
as String,targetClassMemberIds: null == targetClassMemberIds ? _self.targetClassMemberIds : targetClassMemberIds // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String templateId,  String titleSnapshot,  String instructionsSnapshot,  String eligibilityRuleSnapshot,  List<String> targetClassMemberIds,  int pointsUnits, @TimestampConverter()  DateTime startsAt, @TimestampConverter()  DateTime endsAt,  PartyQuestStatus status,  List<String> eligibleMemberIds,  List<String> eligiblePairKeys,  List<String> completedPairKeys, @TimestampConverterOptimistic()  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PartyQuest() when $default != null:
return $default(_that.id,_that.templateId,_that.titleSnapshot,_that.instructionsSnapshot,_that.eligibilityRuleSnapshot,_that.targetClassMemberIds,_that.pointsUnits,_that.startsAt,_that.endsAt,_that.status,_that.eligibleMemberIds,_that.eligiblePairKeys,_that.completedPairKeys,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String templateId,  String titleSnapshot,  String instructionsSnapshot,  String eligibilityRuleSnapshot,  List<String> targetClassMemberIds,  int pointsUnits, @TimestampConverter()  DateTime startsAt, @TimestampConverter()  DateTime endsAt,  PartyQuestStatus status,  List<String> eligibleMemberIds,  List<String> eligiblePairKeys,  List<String> completedPairKeys, @TimestampConverterOptimistic()  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _PartyQuest():
return $default(_that.id,_that.templateId,_that.titleSnapshot,_that.instructionsSnapshot,_that.eligibilityRuleSnapshot,_that.targetClassMemberIds,_that.pointsUnits,_that.startsAt,_that.endsAt,_that.status,_that.eligibleMemberIds,_that.eligiblePairKeys,_that.completedPairKeys,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String templateId,  String titleSnapshot,  String instructionsSnapshot,  String eligibilityRuleSnapshot,  List<String> targetClassMemberIds,  int pointsUnits, @TimestampConverter()  DateTime startsAt, @TimestampConverter()  DateTime endsAt,  PartyQuestStatus status,  List<String> eligibleMemberIds,  List<String> eligiblePairKeys,  List<String> completedPairKeys, @TimestampConverterOptimistic()  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _PartyQuest() when $default != null:
return $default(_that.id,_that.templateId,_that.titleSnapshot,_that.instructionsSnapshot,_that.eligibilityRuleSnapshot,_that.targetClassMemberIds,_that.pointsUnits,_that.startsAt,_that.endsAt,_that.status,_that.eligibleMemberIds,_that.eligiblePairKeys,_that.completedPairKeys,_that.createdAt);case _:
  return null;
...
class _PartyQuest implements PartyQuest {
  const _PartyQuest({required this.id, required this.templateId, required this.titleSnapshot, required this.instructionsSnapshot, required this.eligibilityRuleSnapshot, required  List<String> targetClassMemberIds, required this.pointsUnits, @TimestampConverter() required this.startsAt, @TimestampConverter() required this.endsAt, required this.status,  List<String> eligibleMemberIds = const <String>[],  List<String> eligiblePairKeys = const <String>[],  List<String> completedPairKeys = const <String>[], @TimestampConverterOptimistic() required this.createdAt}): _targetClassMemberIds = targetClassMemberIds,_eligibleMemberIds = eligibleMemberIds,_eligiblePairKeys = eligiblePairKeys,_completedPairKeys = completedPairKeys;
...
@override final  String eligibilityRuleSnapshot;
 final  List<String> _targetClassMemberIds;
@override List<String> get targetClassMemberIds {
  if (_targetClassMemberIds is EqualUnmodifiableListView) return _targetClassMemberIds;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_targetClassMemberIds);
}
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _PartyQuest&&(identical(other.id, id) || other.id == id)&&(identical(other.templateId, templateId) || other.templateId == templateId)&&(identical(other.titleSnapshot, titleSnapshot) || other.titleSnapshot == titleSnapshot)&&(identical(other.instructionsSnapshot, instructionsSnapshot) || other.instructionsSnapshot == instructionsSnapshot)&&(identical(other.eligibilityRuleSnapshot, eligibilityRuleSnapshot) || other.eligibilityRuleSnapshot == eligibilityRuleSnapshot)&&const DeepCollectionEquality().equals(other.targetClassMemberIds, _targetClassMemberIds)&&(identical(other.pointsUnits, pointsUnits) || other.pointsUnits == pointsUnits)&&(identical(other.startsAt, startsAt) || other.startsAt == startsAt)&&(identical(other.endsAt, endsAt) || other.endsAt == endsAt)&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other.eligibleMemberIds, _eligibleMemberIds)&&const DeepCollectionEquality().equals(other.eligiblePairKeys, _eligiblePairKeys)&&const DeepCollectionEquality().equals(other.completedPairKeys, _completedPairKeys)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode {
    return Object.hash(runtimeType,id,templateId,titleSnapshot,instructionsSnapshot,eligibilityRuleSnapshot,const DeepCollectionEquality().hash(_targetClassMemberIds),pointsUnits,startsAt,endsAt,status,const DeepCollectionEquality().hash(_eligibleMemberIds),const DeepCollectionEquality().hash(_eligiblePairKeys),const DeepCollectionEquality().hash(_completedPairKeys),createdAt);
}

@override
String toString() {
    return 'PartyQuest(id: $id, templateId: $templateId, titleSnapshot: $titleSnapshot, instructionsSnapshot: $instructionsSnapshot, eligibilityRuleSnapshot: $eligibilityRuleSnapshot, targetClassMemberIds: $targetClassMemberIds, pointsUnits: $pointsUnits, startsAt: $startsAt, endsAt: $endsAt, status: $status, eligibleMemberIds: $eligibleMemberIds, eligiblePairKeys: $eligiblePairKeys, completedPairKeys: $completedPairKeys, createdAt: $createdAt)';
}
...
as String,instructionsSnapshot: null == instructionsSnapshot ? _self.instructionsSnapshot : instructionsSnapshot // ignore: cast_nullable_to_non_nullable
as String,eligibilityRuleSnapshot: null == eligibilityRuleSnapshot ? _self.eligibilityRuleSnapshot : eligibilityRuleSnapshot // ignore: cast_nullable_to_non_nullable
as String,targetClassMemberIds: null == targetClassMemberIds ? _self._targetClassMemberIds : targetClassMemberIds // ignore: cast_nullable_to_non_nullable
as List<String>,pointsUnits: null == pointsUnits ? _self.pointsUnits : pointsUnits // ignore: cast_nullable_to_non_nullable
as int,startsAt: null == startsAt ? _self.startsAt : startsAt // ignore: cast_nullable_to_non_nullable
as DateTime,endsAt: null == endsAt ? _self.endsAt : endsAt // ignore: cast_nullable_to_non_nullable
as DateTime,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
