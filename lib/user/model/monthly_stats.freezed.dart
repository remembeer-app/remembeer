...
class _MonthlyStats extends MonthlyStats {
  const _MonthlyStats({required this.year, required this.month, required this.beersConsumed, required this.alcoholConsumedMl,  Map<int, DailyStats> dailyStats = const {}}): _dailyStats = dailyStats,super._();
