...
bool operator ==(Object other) {
  final _this = this as DrinkCreate;
...
String toString() {
  final _this = this as DrinkCreate;
  return 'DrinkCreate(name: ${_this.name}, category: ${_this.category}, alcoholPercentage: ${_this.alcoholPercentage})';
}
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _DrinkCreate&&(identical(other.name, name) || other.name == name)&&(identical(other.category, category) || other.category == category)&&(identical(other.alcoholPercentage, alcoholPercentage) || other.alcoholPercentage == alcoholPercentage));
}
...
@override
String toString() {
    return 'DrinkCreate(name: $name, category: $category, alcoholPercentage: $alcoholPercentage)';
}
