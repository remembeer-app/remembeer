...
int get hashCode {
  final _this = this as DrinkCreate;
  return Object.hash(runtimeType,_this.consumedAt,_this.drinkType,_this.volumeInMilliliters,_this.location);
}

@override
String toString() {
  final _this = this as DrinkCreate;
  return 'DrinkCreate(consumedAt: ${_this.consumedAt}, drinkType: ${_this.drinkType}, volumeInMilliliters: ${_this.volumeInMilliliters}, location: ${_this.location})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,consumedAt,drinkType,volumeInMilliliters,location);
}
